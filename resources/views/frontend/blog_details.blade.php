        ...
        <div class="row g-5">
            <div class="col-lg-8">
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb small">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('front.blog') }}" class="text-teal text-decoration-none">Blog</a></li>
                ...
                <div class="mt-5 pt-4 border-top">
                    <span class="me-2 fw-bold small">TAGS:</span>
                    @if($info->tags)
            ...
            <div class="col-lg-4">
                <div class="sticky-top" style="top: 2rem;">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('front.blog') }}" method="GET">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control border-0 bg-light" placeholder="Type keywords...">
                    ...
                    <div class="card border-0 shadow-sm mb-4 rounded-4">
                        <div class="card-body p-4">
                            <h6 class="fw-bold mb-4">Trending Now</h6>
